...
app.get("/hello", (c) => {
  ...
  return c.json({
    message: `Hello, ${name}!`,
    runtime: c.env?.NODE_ENV || "edge"
    // ✅ Use Hono context env, not process.env
  });
});
...
// .wrangler/tmp/bundle-Qq5FtQ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Qq5FtQ/middleware-loader.entry.ts
